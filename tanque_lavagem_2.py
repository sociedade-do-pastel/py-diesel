...
@app.get("/tanque_lavagem_2/", status_code=200)
def obter_volume_tanque_lavagem_2():
    ...
    return {"volume_tanque_lavagem_1": volume_tanque_lavagem_2}
...
def enviar_para_tanque_lavagem_3():
    ...
    while True:
        ...
        if enviar != 0:
            # requests.post(f"http://127.0.0.1:{porta+2}/tanque_lavagem_3",
